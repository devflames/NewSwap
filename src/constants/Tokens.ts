...
export const TOKENS = [
  {
    name: "Wrapped Ether",
    address: "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2", // temporary
    symbol: "WETH",
    decimals: 18,
    chainId: 10001,
    logoURI:
    ...
    kyc: true,
    audit: true,
    kycLink: "https://google.com",
    auditLink: "https://google.com",
  },
  {
    name: "OreoSwap",
    address: "0xCFA6BB519B2253f4731AA7Cb4130b15453fD69f8",
    symbol: "OREO",
    decimals: 18,
    chainId: 10001,
    logoURI:
      "https://cdn2.iconfinder.com/data/icons/desserts-sweets-treats-2/354/Oreo-512.png",
  },
  // {
  //   name: "Dai Stablecoin",
  ...
  // // {
  // //   name: "MILK Token",
  // //   address: "0xdFa1045A662EF30B0178C417Dbf89Fc1B854Fac3",
  // //   symbol: "MILK",
  // //   decimals: 18,
  // //   chainId: 1,
  // //   logoURI:
  // //     "https://w7.pngwing.com/pngs/857/886/png-transparent-milk-drawing-carton-cartoon-milk-photography-graphic-arts-area.png",
  // // }, // temporary
  // {
